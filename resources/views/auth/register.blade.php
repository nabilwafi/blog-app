...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                    ...
                    <div class="card-header bg-primary">
                        <div class="app-brand">
                            <a href="/index.html">
                                ...
                                <span class="brand-name">Nabil Dashboard</span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; 2018 Copyright Admin Dashboard Template by
                <a class="text-primary" href="http://www.facebook.com/" target="_blank">Nabil</a>.
            </p>
        </div>
    </div>
</body>
