  ...
  <div class="col-lg-12">
    ...
    <div class="card card-default">
      <div class="card-header card-header-border-bottom">
        <h2>Contact Update Form Input</h2>
      </div>
      <div class="card-body">
      <form action="{{ url('/admin/create/contact/'.$contact->id) }}" method="POST">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone" id="exampleFormControlFile1" value="{{ $contact->phone }}">
          </div>
